...
const ContactPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-semibold text-gray-900">MedVisit</span>
            </div>
            <div className="hidden md:flex space-x-8">
              ...
              <a href="/contact" className="text-purple-600 font-medium">
                Contact
              </a>
            </div>
          </div>
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-purple-50 to-white py-20 overflow-hidden">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-3">
                <a
                  href="/appointment"
                  className="block text-gray-700 hover:text-purple-600 transition py-2 border-b border-gray-100"
                >
