...
import { Calendar1Icon,CalendarClockIcon, CalendarCheck2, CheckCheckIcon} from "lucide-react";
    ...
    <div>
      <div className="flex items-center gap-1 border-b z-10 fixed top-0  w-[100%] bg-white  justify-between p-3">
        <div className="flex items-center gap-1">
         ...
         }}  variant={"outline"} className="shadow-none hover:cursor-pointer border-1 border-gray-100">Book Appointment</Button>
          </div>
        ...
        "
              >
                ...
                >
                    ...
                    <NavItem icon={<Calendar1Icon size={16} />} label="Book Appoitment " />
                ...
                >
                    ...
                    <NavItem icon={<CalendarClockIcon size={16} />} label="Upcomming Appoitment " />
                ...
                >
                    ...
                    <NavItem icon={<CalendarCheck2 size={16} />} label="Completed Appoitnent" />
                </motion.div>
                ...
                <motion.div
                  ...
                  transition={{
                    ...
                    <div className="mt-2">
                    <NavItem icon={<Calendar1Icon size={16} />} label="Contact Us " />
                    </div>
