  ...
  return (
     <div className="w-full mx-auto mb-2 bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-1">Dr. Sarah Johnson</h2>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <span className="text-xs text-gray-500 uppercase tracking-wider">Booking fee</span>
